...
const LevelScript level_bbh_entry[] = {
	...
	AREA(1, bbh_area_1),
		...
		OBJECT(MODEL_STAR, 807, 1043, -3500, 0, -180, 0, 0x00000000, bhvStar),
		OBJECT(MODEL_STAR, -820, -777, -3500, 0, -180, 0, 0x00000000, bhvStar),
		OBJECT(MODEL_STAR, 807, -594, -3500, 0, -180, 0, 0x00000000, bhvStar),
		OBJECT(MODEL_NONE, -820, -569, -3491, 0, -180, 0, 0x00000000, bhvHiddenRedCoinStar),
		OBJECT(MODEL_TILT_PLATFORM, -820, -876, -3500, 0, -180, 0, 0x00000000, bhvTiltPlatform),
		OBJECT(MODEL_TILT_PLATFORM, 807, -694, -3500, 0, -180, 0, 0x00000000, bhvTiltPlatform),
		OBJECT(MODEL_TILT_PLATFORM, -820, 761, -3500, 0, -180, 0, 0x00000000, bhvTiltPlatform),
		OBJECT(MODEL_TILT_PLATFORM, 807, 943, -3500, 0, -180, 0, 0x00000000, bhvTiltPlatform),
		OBJECT(MODEL_NONE, -1399, 1121, -3500, 0, 0, 0, 0x000A0000, bhvSpinAirborneWarp),
		MARIO_POS(0x01, 0, -1399, 860, -3491),
