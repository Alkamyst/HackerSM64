...
const LevelScript level_castle_grounds_entry[] = {
	...
	AREA(1, castle_grounds_area_1),
		...
		OBJECT(MODEL_LEVEL_BUTTON, -1000, 541, -2546, 0, -180, 0, (1 << 16), bhvLevelButton),
		OBJECT(MODEL_LEVEL_BUTTON, -500, 541, -2546, 0, -180, 0, (2 << 16), bhvLevelButton),
		OBJECT(MODEL_LEVEL_BUTTON, 0, 541, -2546, 0, -180, 0, (3 << 16), bhvLevelButton),
		OBJECT(MODEL_LEVEL_BUTTON, 500, 541, -2546, 0, -180, 0, (4 << 16), bhvLevelButton),
		OBJECT(MODEL_LEVEL_BUTTON, 1000, 541, -2546, 0, -180, 0, (5 << 16), bhvLevelButton),
