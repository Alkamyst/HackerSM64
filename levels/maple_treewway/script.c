...
const LevelScript level_maple_treewway_entry[] = {
	...
	LOAD_MODEL_FROM_GEO(MODEL_GPSWITCH, gpswitch_geo), 
	LOAD_MODEL_FROM_GEO(MODEL_TREE_DOOR, tree_door_geo), 
	...
	AREA(1, maple_treewway_area_1),
		...
		OBJECT(MODEL_EXCLAMATION_BOX, 8740, 8431, -3267, 0, 0, 0, (6 << 16), bhvExclamationBox),
		OBJECT(MODEL_EXCLAMATION_BOX, 12262, 1478, -763, 0, 10, 0, (5 << 16), bhvExclamationBox),
		...
		OBJECT(MODEL_CHESTNUT, 13221, 2305, -1737, -15, -91, 15, (0 << 16), bhvLuigimanChestnut),
		...
		OBJECT(MODEL_NONE, 8740, 8008, -3267, 0, 0, 0, (2 << 16), bhvCoinFormation),
		OBJECT(MODEL_NONE, 9907, 2725, -5977, 0, 0, 0, (2 << 16), bhvCoinFormation),
		OBJECT(MODEL_FLYBUG, 5398, 1210, -5066, 0, -117, 0, 0x00000000, bhvFlyBug),
		OBJECT(MODEL_FLYBUG, 12090, 2526, -3946, 0, -2, 0, 0x00000000, bhvFlyBug),
		...
		OBJECT(MODEL_GOOMBA, 5162, 1249, -3803, 0, 146, 0, (0 << 16), bhvGoomba),
		OBJECT(MODEL_GOOMBA, 7568, 1696, -1813, 0, 36, 0, (0 << 16), bhvGoomba),
		OBJECT(MODEL_GOOMBA, 9139, 1694, -4611, 0, -105, 0, (0 << 16), bhvGoomba),
		OBJECT(MODEL_GOOMBA, 10251, 1696, -2622, 0, -17, 0, (0 << 16), bhvGoomba),
		OBJECT(MODEL_GPSWITCH, 9907, 2725, -5977, 0, 53, 0, 0x00000000, bhvGroundPoundSwitch),
		...
		OBJECT(MODEL_LEAF_PILE, 590, 366, -3910, 0, -60, 0, (1 << 16), bhvLuigimanLeafPile),
		...
		OBJECT(MODEL_LEAF_PILE, 4697, 1256, -1913, -3, 19, 6, (1 << 16), bhvLuigimanLeafPile),
		OBJECT(MODEL_LEAF_PILE, 12973, 2526, -3859, 0, -33, 0, (0 << 16), bhvLuigimanLeafPile),
		...
		OBJECT(MODEL_TREE_DOOR, 8219, 1694, -4042, 0, 0, 0, 0x00000000, bhvTreeDoor),
		...
		OBJECT(MODEL_MAPLE_TREE, 11018, 2526, -3806, 0, 175, 0, (63 << 16), bhvPoleGrabbing),
		OBJECT(MODEL_MAPLE_TREE, 11901, 2125, -1424, 0, 136, 0, (63 << 16), bhvPoleGrabbing),
		OBJECT(MODEL_MAPLE_TREE, 4945, 1276, -2384, 0, 136, 0, (63 << 16), bhvPoleGrabbing),
		OBJECT(MODEL_MAPLE_TREE, 12809, 2526, -4681, 0, 175, 0, (63 << 16), bhvPoleGrabbing),
		OBJECT(MODEL_MAPLE_TREE, 8768, 2725, -6269, 0, -89, 0, (63 << 16), bhvPoleGrabbing),
