...
const LevelScript level_maple_treewway_entry[] = {
	...
	LOAD_MODEL_FROM_GEO(MODEL_TREE_FLOOR, tree_floor_geo), 
	...
	AREA(1, maple_treewway_area_1),
		...
		WARP_NODE(0x01, LEVEL_MAPLE_TREEWWAY, 0x02, 0x0A, WARP_NO_CHECKPOINT),
		WARP_NODE(0x02, LEVEL_BOB, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		WARP_NODE(0x03, LEVEL_MAPLE_TREEWWAY, 0x03, 0x0A, WARP_NO_CHECKPOINT),
		...
		OBJECT(MODEL_WOODEN_SIGNPOST, 1810, 1308, -9066, 0, -91, 0, (0 << 16), bhvMessagePanel),
		OBJECT(MODEL_WOODEN_SIGNPOST, 3718, 150, -9855, 0, 144, 0, (1 << 16), bhvMessagePanel),
		...
		OBJECT(MODEL_NONE, 7866, 1987, -3890, 0, -124, 0, 0x00020000, bhvSpinAirborneWarp),
		OBJECT(MODEL_NONE, 8205, 1718, -3674, 0, 54, 0, 0x08010000, bhvWarp),
		OBJECT(MODEL_NONE, -57, 11, -1350, 0, 54, 0, 0x14030000, bhvWarp),
	...
	AREA(2, maple_treewway_area_2),
		WARP_NODE(0x0A, LEVEL_BOB, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		WARP_NODE(0xF0, LEVEL_BOB, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		WARP_NODE(0xF1, LEVEL_BOB, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		WARP_NODE(0x01, LEVEL_MAPLE_TREEWWAY, 0x01, 0x02, WARP_NO_CHECKPOINT),
		OBJECT(MODEL_EXCLAMATION_BOX, -1457, 1330, -1836, 0, 100, 0, (5 << 16), bhvExclamationBox),
		OBJECT(MODEL_NONE, 1557, 4262, -482, 0, 0, 0, (2 << 16), bhvCoinFormation),
		OBJECT(MODEL_FLYBUG, 883, 1715, 1701, 0, 148, 0, 0x00000000, bhvFlyBug),
		OBJECT(MODEL_FLYBUG, -799, 2232, -207, 0, 90, 0, 0x00000000, bhvFlyBug),
		OBJECT(MODEL_FLYBUG, -1332, 961, -1837, 0, 100, 0, 0x00000000, bhvFlyBug),
		OBJECT(MODEL_FLYBUG, 1828, 3189, -180, 0, -90, 0, 0x00000000, bhvFlyBug),
		OBJECT(MODEL_TREE_FLOOR, 0, -121, -172, 0, 0, 0, 0x00000000, bhvTreeFloor),
		OBJECT(MODEL_GPSWITCH, 5, 4316, -1453, 0, 0, 0, 0x00000000, bhvGroundPoundSwitch),
		OBJECT(MODEL_NONE, 0, 88, 942, 0, -180, 0, 0x000A0000, bhvSpinAirborneWarp),
		OBJECT(MODEL_NONE, 14, 1, 2403, 0, 54, 0, 0x08010000, bhvWarp),
		OBJECT(MODEL_YELLOW_COIN, 294, 3458, -180, 0, 0, 0, 0x00000000, bhvOneCoin),
		OBJECT(MODEL_YELLOW_COIN, 11, 3515, -180, 0, 0, 0, 0x00000000, bhvOneCoin),
		OBJECT(MODEL_YELLOW_COIN, -278, 3458, -180, 0, 0, 0, 0x00000000, bhvOneCoin),
		OBJECT(MODEL_YELLOW_COIN, 834, 961, -1954, 0, 0, 0, 0x00000000, bhvOneCoin),
		OBJECT(MODEL_YELLOW_COIN, 1402, 979, -1756, 0, 0, 0, 0x00000000, bhvOneCoin),
		OBJECT(MODEL_YELLOW_COIN, 1723, 1187, -1277, 0, 0, 0, 0x00000000, bhvOneCoin),
		OBJECT(MODEL_YELLOW_COIN, 2016, 1227, -801, 0, 0, 0, 0x00000000, bhvOneCoin),
		OBJECT(MODEL_YELLOW_COIN, -2227, 3189, -93, 0, 10, 0, 0x00000000, bhvOneCoin),
		OBJECT(MODEL_YELLOW_COIN, -2184, 3189, 139, 0, 10, 0, 0x00000000, bhvOneCoin),
		OBJECT(MODEL_YELLOW_COIN, -2267, 3189, -318, 0, 10, 0, 0x00000000, bhvOneCoin),
		TERRAIN(maple_treewway_area_2_collision),
		MACRO_OBJECTS(maple_treewway_area_2_macro_objs),
		SET_BACKGROUND_MUSIC(0x00, SEQ_LEVEL_GRASS),
		TERRAIN_TYPE(TERRAIN_GRASS),
		/* Fast64 begin persistent block [area commands] */
		/* Fast64 end persistent block [area commands] */
	...
	AREA(3, maple_treewway_area_3),
		WARP_NODE(0x0A, LEVEL_BOB, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		WARP_NODE(0xF0, LEVEL_BOB, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		WARP_NODE(0xF1, LEVEL_BOB, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		OBJECT(MODEL_FLYBUG, 0, 0, 0, 0, 0, 0, 0x00000000, bhvBugaboom),
		OBJECT(MODEL_NONE, 0, 88, 1262, 0, -180, 0, 0x000A0000, bhvSpinAirborneWarp),
		TERRAIN(maple_treewway_area_3_collision),
		MACRO_OBJECTS(maple_treewway_area_3_macro_objs),
		STOP_MUSIC(0),
		TERRAIN_TYPE(TERRAIN_GRASS),
		/* Fast64 begin persistent block [area commands] */
		/* Fast64 end persistent block [area commands] */
