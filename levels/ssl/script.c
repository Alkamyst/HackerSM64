...
const LevelScript level_ssl_entry[] = {
	...
	AREA(1, ssl_area_1),
		...
		OBJECT(MODEL_SLIDE_PLATFORM_SMALL, 1203, -388, -3491, 90, 0, 0, (50 << 16), bhvFan),
		OBJECT(MODEL_SLIDE_PLATFORM_SMALL, -535, 179, -3491, 0, 90, 0, (50 << 16), bhvFan),
		OBJECT(MODEL_SLIDE_PLATFORM_SMALL, 575, 651, -3491, -90, 0, 0, (50 << 16), bhvFan),
		OBJECT(MODEL_SLIDE_PLATFORM_SMALL, -1398, 159, -3491, 0, -90, 0, (50 << 16), bhvFan),
		OBJECT(MODEL_STAR, -541, 515, -3491, 0, -180, 0, 0x00000000, bhvStar),
		OBJECT(MODEL_NONE, 0, 182, -3500, 0, 0, 0, 0x000A0000, bhvSpinAirborneWarp),
		MARIO_POS(0x01, 0, 0, 267, -3491),
