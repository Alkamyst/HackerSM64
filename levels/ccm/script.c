...
const LevelScript level_ccm_entry[] = {
	...
	AREA(2, ccm_area_2),
		...
		OBJECT(MODEL_STAR, 0, 337, -3491, 0, -180, 0, (1 << 24), bhvStar),
	...
	AREA(4, ccm_area_4),
		...
		OBJECT(MODEL_RED_COIN, 835, 250, -3491, 0, -180, 0, 0x00000000, bhvRedCoin),
		OBJECT(MODEL_RED_COIN, -835, 250, -3491, 0, -180, 0, 0x00000000, bhvRedCoin),
		OBJECT(MODEL_SLIDE_PLATFORM_SMALL, 0, -497, -3491, 0, -180, 0, (65 << 24) | (65 << 8), bhvSlidePlatformHori),
		OBJECT(MODEL_STONE_STAR, 0, -365, -3491, 0, -180, 0, (3 << 24), bhvHiddenRedCoinStar),
		OBJECT(MODEL_TILT_PLATFORM, 0, 338, -3491, 0, -180, 0, 0x00000000, bhvTiltPlatform),
		OBJECT(MODEL_NONE, 0, 351, -3500, 0, 0, 0, 0x000A0000, bhvSpinAirborneWarp),
	...
	AREA(5, ccm_area_5),
		...
		OBJECT(MODEL_FAN, 1025, -1000, -3491, -90, 0, 0, (1 << 24) | (200 << 16), bhvFan),
