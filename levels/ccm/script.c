...
const LevelScript level_ccm_entry[] = {
	...
	AREA(1, ccm_area_1),
		...
		OBJECT(MODEL_SLIDE_PLATFORM_SMALL, 0, -108, -3491, -90, 90, 0, (160 << 24) | (0 << 8), bhvSlidePlatformHori),
		OBJECT(MODEL_SLIDE_PLATFORM_SMALL, 0, -803, -3491, 0, -180, 0, (100 << 24) | (0 << 8), bhvSlidePlatformHori),
		OBJECT(MODEL_SLIDE_PLATFORM_SMALL, -300, -549, -3491, 0, -180, 0, (100 << 24) | (60 << 8), bhvSlidePlatformHori),
		OBJECT(MODEL_STAR, 0, -656, -3491, 0, -180, 0, 0x00000000, bhvStar),
		OBJECT(MODEL_TILT_PLATFORM, -200, 700, -3491, 0, -180, 0, 0x00000000, bhvTiltPlatform),
		OBJECT(MODEL_NONE, -700, 713, -3500, 0, 0, 0, 0x000A0000, bhvSpinAirborneWarp),
		MARIO_POS(0x01, 0, -700, 798, -3491),
