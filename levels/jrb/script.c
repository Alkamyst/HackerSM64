...
const LevelScript level_jrb_entry[] = {
	...
	AREA(2, jrb_area_2),
		...
		OBJECT(MODEL_STAR_BALL, 1200, 127, -3491, 0, -180, 0, (1 << 24), bhvBreakableBoxSmall),
		OBJECT(MODEL_SLIDE_PLATFORM_SMALL, 0, -455, -3491, 0, -180, 0, (120 << 24) | (120 << 8), bhvSlidePlatformHori),
		OBJECT(MODEL_TILT_PLATFORM, -1100, -13, -3491, 0, -180, 0, 0x00000000, bhvTiltPlatform),
		OBJECT(MODEL_TILT_PLATFORM, 1200, -13, -3491, 0, -180, 0, 0x00000000, bhvTiltPlatform),
