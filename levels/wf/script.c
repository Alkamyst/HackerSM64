...
const LevelScript level_wf_entry[] = {
	...
	AREA(2, wf_area_2),
		...
		OBJECT(MODEL_SLIDE_PLATFORM_SMALL, -1500, -736, -3491, 0, -180, 0, (150 << 24) | (150 << 8) | (0), bhvSlidePlatformHori),
		OBJECT(MODEL_STAR, -960, -621, -3491, 0, -180, 0, (1 << 24), bhvStar),
		OBJECT(MODEL_TILT_PLATFORM, -960, 614, -3491, 0, -180, 0, 0x00000000, bhvTiltPlatform),
		OBJECT(MODEL_NONE, -1500, 604, -3500, 0, 0, 0, 0x000A0000, bhvSpinAirborneWarp),
		MARIO_POS(0x01, 0, -1500, 688, -3491),
	...
	AREA(4, wf_area_4),
		...
		OBJECT(MODEL_SLIDE_PLATFORM_SMALL, -500, -525, -3491, 0, -180, 0, (50 << 24) | (50 << 8), bhvSlidePlatformHori),
		OBJECT(MODEL_SLIDE_PLATFORM_SMALL, -500, -803, -3491, 0, -180, 0, (100 << 24) | (50 << 8), bhvSlidePlatformHori),
		OBJECT(MODEL_SLIDE_PLATFORM_SMALL, 300, -108, -3491, -90, 90, 0, (160 << 24) | (50 << 8), bhvSlidePlatformHori),
		OBJECT(MODEL_STAR, -500, -656, -3491, 0, -180, 0, (3 << 24), bhvStar),
