...
const LevelScript level_wf_entry[] = {
	...
	AREA(1, wf_area_1),
		...
		OBJECT(MODEL_SLIDE_PLATFORM_SMALL, 200, -325, -3491, 0, -180, 0, (150 << 24) | (30 << 8) | (1), bhvSlidePlatformHori),
		OBJECT(MODEL_STAR, 1239, -210, -3491, 0, -180, 0, 0x00000000, bhvStar),
		OBJECT(MODEL_TILT_PLATFORM, -975, 147, -3491, 0, -180, 0, 0x00000000, bhvTiltPlatform),
		OBJECT(MODEL_NONE, -1395, 340, -3500, 0, 0, 0, 0x000A0000, bhvSpinAirborneWarp),
		MARIO_POS(0x01, 0, -1395, 338, -3491),
	...
	AREA(2, wf_area_2),
		WARP_NODE(0x0A, LEVEL_BOB, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		WARP_NODE(0xF0, LEVEL_WF, 0x03, 0x0A, WARP_NO_CHECKPOINT),
		WARP_NODE(0xF1, LEVEL_WF, 0x02, 0x0A, WARP_NO_CHECKPOINT),
		OBJECT(MODEL_SLIDE_PLATFORM_SMALL, -1500, -1047, -3491, 0, -180, 0, (150 << 24) | (150 << 8) | (0), bhvSlidePlatformHori),
		OBJECT(MODEL_STAR, -960, -932, -3491, 0, -180, 0, (1 << 24), bhvStar),
		OBJECT(MODEL_TILT_PLATFORM, -960, 664, -3491, 0, -180, 0, 0x00000000, bhvTiltPlatform),
		OBJECT(MODEL_NONE, -1580, 654, -3500, 0, 0, 0, 0x000A0000, bhvSpinAirborneWarp),
		MARIO_POS(0x01, 0, -1580, 739, -3491),
	...
	AREA(3, wf_area_3),
		...
		OBJECT(MODEL_SLIDE_PLATFORM_SMALL, 700, -318, -3491, -90, 90, 0, (100 << 24) | (150 << 8), bhvSlidePlatformHori),
		OBJECT(MODEL_SLIDE_PLATFORM_SMALL, 1200, 901, -3491, -90, 90, 0, (150 << 24) | (100 << 8), bhvSlidePlatformHori),
		OBJECT(MODEL_STAR, -1370, -466, -3491, 0, -180, 0, (2 << 24), bhvStar),
		OBJECT(MODEL_NONE, 869, 757, -3500, 0, 0, 0, 0x000A0000, bhvSpinAirborneWarp),
	...
	AREA(4, wf_area_4),
		WARP_NODE(0x0A, LEVEL_BOB, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		WARP_NODE(0xF0, LEVEL_WF, 0x05, 0x0A, WARP_NO_CHECKPOINT),
		WARP_NODE(0xF1, LEVEL_WF, 0x04, 0x0A, WARP_NO_CHECKPOINT),
		OBJECT(MODEL_SLIDE_PLATFORM_SMALL, -300, -525, -3491, 0, -180, 0, (100 << 24) | (30 << 8), bhvSlidePlatformHori),
		OBJECT(MODEL_SLIDE_PLATFORM_SMALL, -300, -803, -3491, 0, -180, 0, (100 << 24) | (30 << 8), bhvSlidePlatformHori),
		OBJECT(MODEL_SLIDE_PLATFORM_SMALL, 1000, -108, -3491, -90, 90, 0, (160 << 24) | (120 << 8) | (1), bhvSlidePlatformHori),
		OBJECT(MODEL_STAR, 0, -656, -3491, 0, -180, 0, (3 << 24), bhvStar),
		OBJECT(MODEL_TILT_PLATFORM, -400, 700, -3491, 0, -180, 0, 0x00000000, bhvTiltPlatform),
		OBJECT(MODEL_NONE, -930, 713, -3500, 0, 0, 0, 0x000A0000, bhvSpinAirborneWarp),
	...
	AREA(5, wf_area_5),
		...
		WARP_NODE(0xF1, LEVEL_WF, 0x05, 0x0A, WARP_NO_CHECKPOINT),
		OBJECT(MODEL_SLIDE_PLATFORM_SMALL, 565, -13, -3491, -180, 0, 90, (60 << 24) | (60 << 8), bhvSlidePlatformVert),
		OBJECT(MODEL_STAR, -1, -831, -3491, 0, -180, 0, (4 << 24), bhvStar),
		OBJECT(MODEL_TILT_PLATFORM, -452, 333, -3491, 0, -180, 0, 0x00000000, bhvTiltPlatform),
		OBJECT(MODEL_NONE, -933, 346, -3500, 0, 0, 0, 0x000A0000, bhvSpinAirborneWarp),
