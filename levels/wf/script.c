...
const LevelScript level_wf_entry[] = {
	...
	AREA(2, wf_area_2),
		...
		OBJECT(MODEL_TILT_PLATFORM, -960, 192, -3491, 0, -180, 0, 0x00000000, bhvTiltPlatform),
		OBJECT(MODEL_NONE, -1500, 182, -3500, 0, 0, 0, 0x000A0000, bhvSpinAirborneWarp),
		MARIO_POS(0x01, 0, -1500, 267, -3491),
	...
	AREA(4, wf_area_4),
		...
		OBJECT(MODEL_SLIDE_PLATFORM_SMALL, 0, -318, -3491, 0, -180, 0, (150 << 24) | (150 << 8), bhvSlidePlatformHori),
		OBJECT(MODEL_SLIDE_PLATFORM_SMALL, 1500, 901, -3491, -90, 90, 0, (150 << 24) | (150 << 8), bhvSlidePlatformHori),
		OBJECT(MODEL_STAR, 869, -172, -3491, 0, -180, 0, (3 << 24), bhvStar),
		OBJECT(MODEL_NONE, 869, 757, -3500, 0, 0, 0, 0x000A0000, bhvSpinAirborneWarp),
	...
	AREA(5, wf_area_5),
		...
		OBJECT(MODEL_SLIDE_PLATFORM_SMALL, -500, -549, -3491, 0, -180, 0, (100 << 24) | (80 << 8), bhvSlidePlatformHori),
		OBJECT(MODEL_SLIDE_PLATFORM_SMALL, -200, -803, -3491, 0, -180, 0, (100 << 24) | (20 << 8), bhvSlidePlatformHori),
		OBJECT(MODEL_SLIDE_PLATFORM_SMALL, -200, -108, -3491, -90, 90, 0, (160 << 24) | (20 << 8), bhvSlidePlatformHori),
		OBJECT(MODEL_STAR, -200, -656, -3491, 0, -180, 0, (4 << 24), bhvStar),
		OBJECT(MODEL_TILT_PLATFORM, -400, 700, -3491, 0, -180, 0, 0x00000000, bhvTiltPlatform),
		OBJECT(MODEL_NONE, -800, 713, -3500, 0, 0, 0, 0x000A0000, bhvSpinAirborneWarp),
