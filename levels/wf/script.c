...
const LevelScript level_wf_entry[] = {
	...
	AREA(2, wf_area_2),
		...
		OBJECT(MODEL_SLIDE_PLATFORM_SMALL, 0, -457, -3491, 0, -180, 0, (100 << 24) | (100 << 8) | (0), bhvSlidePlatformHori),
		OBJECT(MODEL_STAR, 0, -347, -3491, 0, -180, 0, (1 << 24), bhvStar),
		OBJECT(MODEL_TILT_PLATFORM, 0, 432, -3491, 0, -180, 0, 0x00000000, bhvTiltPlatform),
		OBJECT(MODEL_NONE, 0, 422, -3500, 0, 0, 0, 0x000A0000, bhvSpinAirborneWarp),
		MARIO_POS(0x01, 0, 0, 507, -3491),
	...
	AREA(5, wf_area_5),
		...
		OBJECT(MODEL_SLIDE_PLATFORM_SIDEWAYS, 565, -13, -3491, -180, 0, 90, (80 << 24) | (60 << 8), bhvSlidePlatformVert),
