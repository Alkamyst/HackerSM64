...
void scroll_wf_dl_Cube_mesh_layer_5_vtx_1() {
	int i = 0;
	int count = 32;
	int width = 32 * 0x20;
	int height = 64 * 0x20;
	...
	static int currentY = 0;
	int deltaY;
	Vtx *vertices = segmented_to_virtual(wf_dl_Cube_mesh_layer_5_vtx_1);
...
void scroll_wf_dl_Cube_001_mesh_layer_5_vtx_1() {
	int i = 0;
	int count = 32;
	int width = 32 * 0x20;
	int height = 64 * 0x20;
	...
	static int currentY = 0;
	int deltaY;
	Vtx *vertices = segmented_to_virtual(wf_dl_Cube_001_mesh_layer_5_vtx_1);
...
void scroll_wf_dl_Cube_002_mesh_layer_5_vtx_1() {
	int i = 0;
	int count = 32;
	int width = 32 * 0x20;
	int height = 64 * 0x20;
	...
	static int currentY = 0;
	int deltaY;
	Vtx *vertices = segmented_to_virtual(wf_dl_Cube_002_mesh_layer_5_vtx_1);
...
void scroll_wf_dl_Cube_004_mesh_layer_5_vtx_1() {
	int i = 0;
	int count = 32;
	int width = 32 * 0x20;
	int height = 64 * 0x20;
	...
	static int currentY = 0;
	int deltaY;
	Vtx *vertices = segmented_to_virtual(wf_dl_Cube_004_mesh_layer_5_vtx_1);
...
void scroll_wf_dl_Cube_005_mesh_layer_5_vtx_1() {
	int i = 0;
	int count = 32;
	int width = 32 * 0x20;
	int height = 64 * 0x20;
	...
	static int currentY = 0;
	int deltaY;
	Vtx *vertices = segmented_to_virtual(wf_dl_Cube_005_mesh_layer_5_vtx_1);
...
void scroll_wf() {
	...
	scroll_wf_dl_Cube_mesh_layer_5_vtx_1();
	...
	scroll_wf_dl_Cube_001_mesh_layer_5_vtx_1();
	...
	scroll_wf_dl_Cube_002_mesh_layer_5_vtx_1();
	...
	scroll_wf_dl_Cube_004_mesh_layer_5_vtx_1();
	...
	scroll_wf_dl_Cube_005_mesh_layer_5_vtx_1();
