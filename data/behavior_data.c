...
extern void bhv_tilt_platform();
const BehaviorScript bhvTiltPlatformWide[] = {
    BEGIN(OBJ_LIST_SURFACE),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE),
    LOAD_COLLISION_DATA(tilt_platform_wide_collision),
    SET_FLOAT(oDrawingDistance, 20000),
    BEGIN_LOOP(),
        CALL_NATIVE(bhv_tilt_platform),
        CALL_NATIVE(load_object_collision_model),
    END_LOOP(),
};

extern void bhv_tilt_platform();
const BehaviorScript bhvTiltPlatform[] = {
    BEGIN(OBJ_LIST_SURFACE),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE),
    LOAD_COLLISION_DATA(tilt_platform_collision),
    SET_FLOAT(oDrawingDistance, 20000),
    BEGIN_LOOP(),
        CALL_NATIVE(bhv_tilt_platform),
        CALL_NATIVE(load_object_collision_model),
...
extern void bhv_tilt_box();
const BehaviorScript bhvTiltBox[] = {
    BEGIN(OBJ_LIST_SURFACE),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE),
    LOAD_COLLISION_DATA(tilt_box_collision),
    SET_FLOAT(oDrawingDistance, 20000),
    BEGIN_LOOP(),
        CALL_NATIVE(bhv_tilt_box),
        CALL_NATIVE(load_object_collision_model),
    END_LOOP(),
};

extern void bhv_slide_platform_hori();
const BehaviorScript bhvSlidePlatformHori[] = {
    BEGIN(OBJ_LIST_SURFACE),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE),
    LOAD_COLLISION_DATA(slide_platform_small_collision),
    SET_FLOAT(oDrawingDistance, 20000),
    BEGIN_LOOP(),
        CALL_NATIVE(bhv_slide_platform_hori),
        CALL_NATIVE(load_object_collision_model),
    END_LOOP(),
};
