...
Gfx *omm_geo_star_enable_effects(s32 callContext, struct GraphNode *node) {
...
Gfx *omm_geo_star_update_glow(s32 callContext, struct GraphNode *node) {
...
Gfx *omm_geo_star_update_ray(s32 callContext, struct GraphNode *node) {
    if (gCurGraphNodeObject && callContext == GEO_CONTEXT_RENDER) {
